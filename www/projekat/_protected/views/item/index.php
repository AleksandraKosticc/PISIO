...
<div class="item-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Person', 'id' => 'grid-item-search-person_id']
            ],
        [
                'attribute' => 'status_id',
                ...
                'filterInputOptions' => ['placeholder' => 'Status', 'id' => 'grid-item-search-status_id']
            ],
        [
                'attribute' => 'location_id',
                'label' => Yii::t('app', 'Location'),
                'value' => function($model){                   
                    return $model->location->lat_lon;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                ...
                'filterInputOptions' => ['placeholder' => 'Location', 'id' => 'grid-item-search-location_id']
            ],
        [
                'attribute' => 'type_id',
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Type::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Type', 'id' => 'grid-item-search-type_id']
            ],
        [
