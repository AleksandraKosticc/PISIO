...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'person_id' => [
            ...
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\Person::find()->orderBy('title')->asArray()->all(), 'id', 'lastname'),
        ...
        'type_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\app\models\Type::find()->orderBy('name')->asArray()->all(), 'id', 'name'),
